...
${OBJECTDIR}/src/cameras/Cam.o: src/cameras/Cam.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/Cam.o src/cameras/Cam.cpp

${OBJECTDIR}/src/cameras/CameraMan2.o: src/cameras/CameraMan2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cameras
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/CameraMan2.o src/cameras/CameraMan2.cpp
...
${OBJECTDIR}/src/scenegraph/Node.o: src/scenegraph/Node.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Node.o src/scenegraph/Node.cpp

${OBJECTDIR}/src/resource/Token.o: src/resource/Token.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/resource
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/resource/Token.o src/resource/Token.cpp

${OBJECTDIR}/src/appearance/PolyAtt.o: src/appearance/PolyAtt.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/PolyAtt.o src/appearance/PolyAtt.cpp

${OBJECTDIR}/src/scenegraph/Spatial.o: src/scenegraph/Spatial.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Spatial.o src/scenegraph/Spatial.cpp

${OBJECTDIR}/src/collision/BoundingVolume.o: src/collision/BoundingVolume.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/collision
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/collision/BoundingVolume.o src/collision/BoundingVolume.cpp

${OBJECTDIR}/src/lights/SpotLight.o: src/lights/SpotLight.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/lights
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lights/SpotLight.o src/lights/SpotLight.cpp

${OBJECTDIR}/src/collision/BoundingSphere.o: src/collision/BoundingSphere.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/collision
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/collision/BoundingSphere.o src/collision/BoundingSphere.cpp

${OBJECTDIR}/src/events/EventHandler.o: src/events/EventHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/events
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/events/EventHandler.o src/events/EventHandler.cpp

${OBJECTDIR}/src/resource/ResourceManager.o: src/resource/ResourceManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/resource
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/resource/ResourceManager.o src/resource/ResourceManager.cpp

${OBJECTDIR}/src/lights/DirLight.o: src/lights/DirLight.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/lights
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lights/DirLight.o src/lights/DirLight.cpp

${OBJECTDIR}/src/utils/Object.o: src/utils/Object.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/utils
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/utils/Object.o src/utils/Object.cpp

${OBJECTDIR}/src/scenegraph/Trimesh.o: src/scenegraph/Trimesh.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Trimesh.o src/scenegraph/Trimesh.cpp

${OBJECTDIR}/src/maths/Vec.o: src/maths/Vec.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Vec.o src/maths/Vec.cpp

${OBJECTDIR}/src/scenegraph/Geom.o: src/scenegraph/Geom.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Geom.o src/scenegraph/Geom.cpp

${OBJECTDIR}/src/lights/Light.o: src/lights/Light.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/lights
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lights/Light.o src/lights/Light.cpp

${OBJECTDIR}/src/lights/LightBulb.o: src/lights/LightBulb.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/lights
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lights/LightBulb.o src/lights/LightBulb.cpp

${OBJECTDIR}/src/maths/Mat4.o: src/maths/Mat4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Mat4.o src/maths/Mat4.cpp

${OBJECTDIR}/src/scenegraph/App.o: src/scenegraph/App.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/App.o src/scenegraph/App.cpp
...
${OBJECTDIR}/src/events/CollisionDetector.o: src/events/CollisionDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/events
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/events/CollisionDetector.o src/events/CollisionDetector.cpp

${OBJECTDIR}/src/resource/OBJLoader.o: src/resource/OBJLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/resource
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/resource/OBJLoader.o src/resource/OBJLoader.cpp

${OBJECTDIR}/src/scenegraph/TexCoord.o: src/scenegraph/TexCoord.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/TexCoord.o src/scenegraph/TexCoord.cpp

${OBJECTDIR}/src/maths/Vec2.o: src/maths/Vec2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Vec2.o src/maths/Vec2.cpp

${OBJECTDIR}/src/maths/FastMath.o: src/maths/FastMath.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/FastMath.o src/maths/FastMath.cpp

${OBJECTDIR}/src/appearance/PointAtt.o: src/appearance/PointAtt.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/PointAtt.o src/appearance/PointAtt.cpp

${OBJECTDIR}/src/lights/LightMan.o: src/lights/LightMan.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/lights
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lights/LightMan.o src/lights/LightMan.cpp

${OBJECTDIR}/src/cameras/CameraMan3.o: src/cameras/CameraMan3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cameras
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/CameraMan3.o src/cameras/CameraMan3.cpp

${OBJECTDIR}/src/scenegraph/Bound.o: src/scenegraph/Bound.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Bound.o src/scenegraph/Bound.cpp

${OBJECTDIR}/src/scenegraph/Trfm.o: src/scenegraph/Trfm.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/scenegraph
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/scenegraph/Trfm.o src/scenegraph/Trfm.cpp

${OBJECTDIR}/src/appearance/Material.o: src/appearance/Material.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/Material.o src/appearance/Material.cpp

${OBJECTDIR}/src/resource/OBJLexicalAnalyser.o: src/resource/OBJLexicalAnalyser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/resource
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/resource/OBJLexicalAnalyser.o src/resource/OBJLexicalAnalyser.cpp

${OBJECTDIR}/src/cameras/Cam3.o: src/cameras/Cam3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cameras
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/Cam3.o src/cameras/Cam3.cpp

${OBJECTDIR}/src/appearance/LineAtt.o: src/appearance/LineAtt.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/LineAtt.o src/appearance/LineAtt.cpp

${OBJECTDIR}/src/cameras/Cam2.o: src/cameras/Cam2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cameras
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/Cam2.o src/cameras/Cam2.cpp

${OBJECTDIR}/src/utils/GetNode.o: src/utils/GetNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/utils
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/utils/GetNode.o src/utils/GetNode.cpp

${OBJECTDIR}/src/maths/Plane.o: src/maths/Plane.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Plane.o src/maths/Plane.cpp

${OBJECTDIR}/src/events/CollisionEvent.o: src/events/CollisionEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/events
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/events/CollisionEvent.o src/events/CollisionEvent.cpp

${OBJECTDIR}/src/cameras/Viewport.o: src/cameras/Viewport.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cameras
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cameras/Viewport.o src/cameras/Viewport.cpp

${OBJECTDIR}/src/appearance/Texture.o: src/appearance/Texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/Texture.o src/appearance/Texture.cpp

${OBJECTDIR}/src/maths/Mat3.o: src/maths/Mat3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Mat3.o src/maths/Mat3.cpp

${OBJECTDIR}/src/maths/Mat2.o: src/maths/Mat2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Mat2.o src/maths/Mat2.cpp

${OBJECTDIR}/src/maths/Mat.o: src/maths/Mat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/maths
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/maths/Mat.o src/maths/Mat.cpp

${OBJECTDIR}/src/appearance/Colour.o: src/appearance/Colour.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/appearance
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/appearance/Colour.o src/appearance/Colour.cpp
